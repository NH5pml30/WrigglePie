...
inline std::unique_ptr<Tree> ternary_op(std::string node, std::unique_ptr<Tree> lhs, std::unique_ptr<Tree> chs, std::unique_ptr<Tree> rhs)
{
  return NodeBuilder(std::move(node)).add(std::move(lhs)).add(std::move(chs)).add(std::move(rhs)).finish();
}

inline std::unique_ptr<Tree> binary_op(std::string node, std::unique_ptr<Tree> lhs, std::unique_ptr<Tree> rhs)
{
  return NodeBuilder(std::move(node)).add(std::move(lhs)).add(std::move(rhs)).finish();
}

inline std::unique_ptr<Tree> unary_op(std::string node, std::unique_ptr<Tree> arg)
{
  return NodeBuilder(std::move(node)).add(std::move(arg)).finish();
}
